    ...
    <section className="w-full py-24 bg-white font-manrope">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div
          ...
          className="text-center flex items-center justify-center md:mb-16 mb-5"
        >
          <h2 className="text-3xl md:text-5xl font-semibold max-w-2xl text-[#0B3963] tracking-tight">
            What make Fusremit a great place work?
          </h2>
        </motion.div>
                ...
                <img
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src =
                      "https://placehold.co/400x400/F0F5FF/0B3963?text=Benefit+Image";
                  }}
                />
              </div>
