...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full md:min-h-screen font-manrope bg-[#F0F5FF] overflow-hidden">
      <div className="absolute top-0 right-0 w-1/2 h-full bg-linear-to-l from-[#B6CCFF]/30 to-transparent hidden md:block" />

      <div className="max-w-full mx-auto px-6 md:px-25 py-12 md:py-30 grid md:grid-cols-2 gap-12 items-center">
        {/* Left content */}
        <motion.div
          ...
          className="relative md:pt-0 pt-10 z-10"
        >
          ...
          <h1 className="text-4xl md:text-7xl font-extrabold text-[#020617] leading-[1.1] tracking-tight">
            Send Money <br />
            <span className="text-[#0B3963]">Global With Ease</span>
          </h1>
          ...
          >
            ...
            <button className="flex items-center gap-3 px-4 py-2 bg-white rounded-lg">
              <img src="/images/playstore.png" alt="PlayStore" className="h-7 w-auto" />
              <div className="flex flex-col items-start leading-none">
                <span className="text-[10px] font-medium text-gray-600">
                  GET IT ON
                </span>
